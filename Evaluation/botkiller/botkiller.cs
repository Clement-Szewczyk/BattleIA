...
{   
    ...
    public class killer
    {
        ...
        // Liste qui permet de stocker les positins des ennemies
        List<(int, int) > positionEnnemie = new List<(int, int)>();
        // variable permettant de savoir la direction d'un ennemie
        int directennemie;
...
;
        ...
        public byte GetScanSurface()
        {
            ...
            // Scan de 4 quand on a fini la liste
        ...
        {       
            ...
            if (nbenergie >=1){
                ...
                // S'il n'y a pas d'énergie, on ne fait rien
                rien = true;
            }
            ...
            positionEnnemie.Clear(); // on vide la liste des positions ennemies
            ...
            // Pour chaque position ennemie, on regarde ou il se trouve par rapport au robot
        ...
        {  
            // S'il n'y pas d'ennmie en ligne de tir
            if (directennemie ==0){
            ...
            // Si l'énemie est en ligne de tir
            if (directennemie == 1){
                directennemie = 0;
